...
class NGCF(torch.nn.Module):
    def __init__(self, v_feat, a_feat, t_feat, edge_index, batch_size, num_user, num_item, dim_latent, dim_hidden=128):
        ...
        self.dim_feat = v_feat.size(1) + a_feat.size(1) + t_feat.size(1)
        ...
        self.t_feat = torch.tensor(t_feat, requires_grad=False, dtype=torch.float).cuda()
